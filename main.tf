...
provisioner "file" {
    ...
    destination = "/root/.ssh/storagebox/id_rsa"
...
provisioner "remote-exec" {
    ...
    inline = [
      "chmod +x /tmp/code.sh",
      "/tmp/code.sh ${var.user_input.storage_id} ${var.user_input.project_id} ${var.user_input.docker_image} ${var.user_input.command}"
    ]
    when = create
